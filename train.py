...
train_df = pd.read_csv('/kaggle/input/pr-title/train.csv')
eval_df = pd.read_csv('/kaggle/input/pr-title/valid.csv')
test_df = pd.read_csv('/kaggle/input/pr-title/test.csv')

# train_df = pd.read_csv('test1.csv')
# eval_df = pd.read_csv('test1.csv')
...
from nlgeval import compute_metrics, _strip, Rouge
